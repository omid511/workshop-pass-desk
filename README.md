...
The included [Playground Blueprint](blueprint/blueprint.json) installs WordPress and WooCommerce and loads the public GitHub archive (whose extracted folder is `workshop-pass-desk-main`). For a local ZIP demo:
